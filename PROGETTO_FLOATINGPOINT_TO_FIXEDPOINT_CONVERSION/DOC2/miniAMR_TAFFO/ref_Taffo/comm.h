...
#ifdef MA_MAIN
double *send_buff __attribute((annotate("scalar(range(0.0,1000))")));
#else
EXTERN double *send_buff;
#endif

#ifdef MA_MAIN
double *recv_buff __attribute((annotate("scalar(range(0.0,1000))")));
#else
EXTERN double *recv_buff;
#endif


//range tra il 0 e 1000
