                            ...
                            for (i2 = i = 1; i <= x_block_half; i++, i2+=2)
                                for (j2 = j = 1; j <= y_block_half; j++, j2+=2)
                                    for (k2 = k = 1; k <= z_block_half; k++, k2+=2)
                                        (blocks_arrays[m])[v][i2  ][j2  ][k2  ] =
                                        (blocks_arrays[m])[v][i2+1][j2  ][k2  ] =
                                        (blocks_arrays[m])[v][i2  ][j2+1][k2  ] =
                                        (blocks_arrays[m])[v][i2+1][j2+1][k2  ] =
                                        (blocks_arrays[m])[v][i2  ][j2  ][k2+1] =
                                        (blocks_arrays[m])[v][i2+1][j2  ][k2+1] =
                                        (blocks_arrays[m])[v][i2  ][j2+1][k2+1] =
                                        (blocks_arrays[m])[v][i2+1][j2+1][k2+1] =
                                                (blocks_arrays[n])[v][i+i1][j+j1][k+k1]/8.0;
                    }
                ...
                for (o = 0; o < 8; o++) {
                    ...
                    for (v = 0; v < num_vars; v++)
                        for (i2 = i = 1; i <= x_block_half; i++, i2+=2)
                            for (j2 = j = 1; j <= y_block_half; j++, j2+=2)
                                for (k2 = k = 1; k <= z_block_half; k++, k2+=2)
                                    (blocks_arrays[n])[v][i+i1][j+j1][k+k1] =
                                            (blocks_arrays[pp->child[o]])[v][i2  ][j2  ][k2  ] +
                                            (blocks_arrays[pp->child[o]])[v][i2+1][j2  ][k2  ] +
                                            (blocks_arrays[pp->child[o]])[v][i2  ][j2+1][k2  ] +
                                            (blocks_arrays[pp->child[o]])[v][i2+1][j2+1][k2  ] +
                                            (blocks_arrays[pp->child[o]])[v][i2  ][j2  ][k2+1] +
                                            (blocks_arrays[pp->child[o]])[v][i2+1][j2  ][k2+1] +
                                            (blocks_arrays[pp->child[o]])[v][i2  ][j2+1][k2+1] +
                                            (blocks_arrays[pp->child[o]])[v][i2+1][j2+1][k2+1];
                }
