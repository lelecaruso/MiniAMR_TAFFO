...
#ifdef MA_MAIN
double *****blocks_arrays __attribute((annotate("target('blocks_arrays')scalar(range(0.0,1.0))")));
#else
EXTERN double *****blocks_arrays;
#endif
...
#ifdef MA_MAIN
double *grid_sum __attribute((annotate("scalar(range(0.0,100000000))")));
#else
EXTERN double *grid_sum;
#endif
...
//EXTERN double *a0, a1;
#ifdef MA_MAIN
double *a0 __attribute((annotate("scalar(range(0.0,1.0))")));
#else
EXTERN double *a0;
#endif

#ifdef MA_MAIN
double a1 __attribute((annotate("scalar(range(0.0,1.0))")));
#else
EXTERN double a1;
#endif
